...
export const POSTS: BlogPost[] = [
  ...
  // ────────────────────────────────────────────────────────
  {
    ...
    blocks: [
      ...
      { type: 'p', text: 'There are only a handful of places on Earth with coastal dune lakes, and Western Lake in Grayton Beach State Park is the postcard one. Rent a paddleboard or kayak and glide across dark, still water with white dunes on one side and pines on the other.' },
      ...
      { type: 'p', text: 'The 19-mile paved path runs the full length of Scenic Highway 30A, connecting every beach town. Rent bikes (most rentals deliver to your door, just ask our concierge team) and spend a morning rolling from Seaside to Rosemary Beach with coffee stops on the way.' },
